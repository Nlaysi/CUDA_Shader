...
#line 1 "C:/Users/Иван/source/repos/Shaders/JuliaFractal.cu"
...
#pragma warning(pop)
#line 2 "C:/Users/Иван/source/repos/Shaders/JuliaFractal.cu"
extern "C"  __noinline__ void draw2(unsigned char *data) ;
#if 0
#line 2
{ 
#line 3
...
#line 8
(data[((1920 * 3) * y) + (3 * x)]) = ((unsigned char)((double)255)); 
#line 9
(data[(((1920 * 3) * y) + (3 * x)) + 1]) = ((unsigned char)((double)255)); 
#line 10
(data[(((1920 * 3) * y) + (3 * x)) + 2]) = ((unsigned char)((double)255)); 
#line 11
} 
#endif
#line 1 "JuliaFractal.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__20_JuliaFractal_cpp1_ii_draw2
#pragma pack()
#line 1 "JuliaFractal.cudafe1.stub.c"
#include "JuliaFractal.cudafe1.stub.c"
#line 1 "JuliaFractal.cudafe1.stub.c"
